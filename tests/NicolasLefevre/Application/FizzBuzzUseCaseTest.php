...
final class FizzBuzzUseCaseTest extends TestCase
{
    ...
    {
        $this->assertSame(['1'], ($this->handler->__invoke(new FizzBuzzQuery(1))->toArray()));
    }

    /** @test */
    public function itShouldReturn2With2(): void
    {
        $this->assertSame(['2'], ($this->handler->__invoke(new FizzBuzzQuery(2))->toArray()));
    }

    /** @test */
    public function itShouldReturnFizzWith3(): void
    {
        $this->assertSame(['Fizz'], ($this->handler->__invoke(new FizzBuzzQuery(3))->toArray()));
    }

    /** @test */
    public function itShouldReturnBuzzWith5(): void
    {
        $this->assertSame(['Buzz'], ($this->handler->__invoke(new FizzBuzzQuery(5))->toArray()));
    }

    /** @test */
    public function itShouldReturnFizzWith6(): void
    {
        $this->assertSame(['Fizz'], ($this->handler->__invoke(new FizzBuzzQuery(6))->toArray()));
    }

    /** @test */
    public function itShouldReturnFizzWith9(): void
    {
        $this->assertSame(['Fizz'], ($this->handler->__invoke(new FizzBuzzQuery(9))->toArray()));
    }

    /** @test */
    public function itShouldReturnFizzWith10(): void
    {
        $this->assertSame(['Buzz'], ($this->handler->__invoke(new FizzBuzzQuery(10))->toArray()));
    }

    /** @test */
    public function itShouldReturnFizzBuzzWith15(): void
    {
        $this->assertSame(['FizzBuzz'], ($this->handler->__invoke(new FizzBuzzQuery(15))->toArray()));
    }

    /** @test */
    public function itShouldReturnFizzBuzzWith30(): void
    {
        $this->assertSame(['FizzBuzz'], ($this->handler->__invoke(new FizzBuzzQuery(30))->toArray()));
    }

    /** @test */
    public function itShouldReturn12With1and2(): void
    {
        $this->assertSame(["1", "2"], ($this->handler->__invoke(new FizzBuzzQuery(1, 2))->toArray()));
    }

    /** @test */
    public function itShouldReturn12FizzWith1and2and3(): void
    {
        $this->assertSame(['1', '2', 'Fizz'], ($this->handler->__invoke(new FizzBuzzQuery(1, 3))->toArray()));
    }
    ...
    public function itShouldReturn12FizzWithRange1to5(): void
    {
        $this->assertSame(['1', '2', 'Fizz', '4', 'Buzz'],
            ($this->handler->__invoke(new FizzBuzzQuery(1, 5))->toArray()),
        );
    }
    ...
    public function itShouldThrowErrorWhenFromIsNegative(): void
    {
        ...
        $this->handler->__invoke(new FizzBuzzQuery(-1));
    }
    ...
    {
        $this->expectException(NumberMustBePositiveError::class);
        $this->handler->__invoke(new FizzBuzzQuery(0, -1));
    }
    ...
    public function itShouldThrowErrorWhenFromIsBiggerThanTo(): void
    {
        ...
        $this->handler->__invoke(new FizzBuzzQuery(10, 5));
    }

    /** @test */
    public function itShouldReturn1WhenFromIs1AndToIs1(): void
    {
        $this->assertSame(['1'], ($this->handler->__invoke(new FizzBuzzQuery(1, 1))->toArray()));
    }
}
